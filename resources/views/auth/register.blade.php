                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <input id="name" type="text" class="form-control @error('Imie') is-invalid @enderror" name="name" value="{{ old('Imie') }}" required autocomplete="name" autofocus>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <input id="surnname" type="text" class="form-control @error('Nazwisko') is-invalid @enderror" name="surname" value="{{ old('Nazwisko') }}" required autocomplete="surname" autofocus>
